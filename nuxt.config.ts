  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { name: 'keywords', content: '두산위브,제니스,학정역,분양,모델하우스,견본하우스,칠곡,대구' },
        ...
        { property: 'og:image', content: 'https://xn--hu1bq8p65bh1h6oby7bg90c.kr/og_img.png' },
        ...
        { name: 'twitter:image', content: 'https://xn--hu1bq8p65bh1h6oby7bg90c.kr/og_img.png' },
