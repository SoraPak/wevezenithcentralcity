...
<Popup class="guidePopup guidePopup3" ref="popup3">
  ...
  <div class="itd">
    <p>안녕하세요, 박소라 과장입니다.</p>
    <p>저는 대구 칠곡에서 초, 중, 고를 졸업하고 일본에서 오랫동안 웹개발자로 활동해 왔습니다. 2024년에 한국에 돌아와 신현주 팀장님의 권유로 두산위브더제니스에서 분양 업무를 시작하게 되었죠. 처음 경험하는 분양 업계이지만, 저는 <strong>스스로 기획 한 것을 디자인, 구현(개발)까지 혼자서 모두 소화할 수 있는 강점</strong>을 바탕으로 광고 영업에 힘을 쏟고 보람도 느끼고 있습니다.</p>
