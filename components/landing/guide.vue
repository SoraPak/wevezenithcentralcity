    ...
    <div class="guide_inner">
      ...
      <div class="section01">
        ...
        <div class="left">
          ...
          <p class="comment">모델하우스는 <strong>사전예약 및 담당자 지정제</strong>로 운영되고 있습니다(당일예약 가능). 모델하우스 카운터에서 <strong>박소라 과장</strong>을 찾아주세요.<span style="display: inline-block; font-weight: bolder; font-size: 83%; color: #e20000;">그냥 오시면 선물이 제공 안되요ㅠㅠ</span></p>
        </div>
        <ul class="links">
...
<Popup class="guidePopup guidePopup3" ref="popup3">
  ...
  <div class="itd">
    <p>안녕하세요, 박소라 과장입니다.</p>
    <p>저는 대구 칠곡에서 초, 중, 고교를 졸업하고 일본에서 오랫동안 웹개발자로 활동해 왔습니다. 2024년에 한국에 돌아와 신현주 팀장님의 권유로 두산위브더제니스에서 분양 업무를 시작하게 되었죠. 처음 경험하는 분양 업계이지만, 저는 <strong>기획부터 디자인, 개발까지 혼자서 모두 소화할 수 있는 강점</strong>을 바탕으로 광고 영업에 큰 힘을 쏟고 있습니다.</p>
    <p>모델하우스를 방문하시면 단지의 입지, 커뮤니티 시설, 모형 조감도 등을 안내해드리고, 고객님께 꼭 맞는 유닛 투어를 도와드리며, 신현주 팀장님과 연결하여 고객님이 필요한 정보를 꼼꼼히 받으실 수 있도록 돕고 있습니다.</p>
    <p>제가 가진 기술을 통해 이 아파트의 가치를 고객님께 진심으로 전달하고, 최고의 선택을 하실 수 있도록 최선을 다하겠습니다.</p>
  </div>
</Popup>
<!-- Popup ref="popup3">
  <h1 class="popup_ttl">
