...
const reviews = ref([
  {
    ...
    content: [
      "저는 90년대 초 칠곡 2지구 개발 때 구암동 미래타운에 입주해서 30년 동안 큰 불편 없이 살아왔습니다. 그동안 리모델링을 하며 계속 살고 있었지만, 아무래도 아파트가 점점 노후화되다 보니 새 아파트로 갈아타야겠다는 생각이 들었죠. 그래서 얼마 전 두산위브더제니스 센트럴시티 모델하우스를 방문하고, 정말 고민 없이 계약을 결정했습니다!",
      "무엇보다 1,000세대 대단지라는 안정감이 좋았고, 특히 1층 필로티 설계 덕분에 동선이 훨씬 자유롭고 편리해졌다는 점이 마음에 쏙 들었어요. 그리고 농어촌 기술원 이전 후 칠곡 4지구가 새롭게 형성되면 이곳이 정말 새로운 주거 타운으로 자리 잡을 거라는 기대감도 컸습니다.",
      "저는 33B타입 고층으로 계약했는데, 전망도 좋고 공간 활용도 뛰어나더라고요. 지금 살고 있는 곳과 비교해보면 확실히 더 업그레이드된 느낌이 들었어요.",
